...
public class GarnishedAdditionsNeoForgeMain {
    ...
    public GarnishedAdditionsNeoForgeMain(IEventBus eventBus, ModContainer modContainer) {
...
//                registerBuiltinResourcePack(event, "chromatic_compound_fix");
//            }
//
//        }
//
//        private static void registerBuiltinResourcePack(AddPackFindersEvent event, String folder) {
//            event.addPackFinders(GarnishedAdditionsNeoForgeMain.asResource("resourcepacks/" + folder), PackType.CLIENT_RESOURCES, Component.literal("garnished_additions/" + folder), PackSource.BUILT_IN, true, Pack.Position.TOP);
//        }
    }
